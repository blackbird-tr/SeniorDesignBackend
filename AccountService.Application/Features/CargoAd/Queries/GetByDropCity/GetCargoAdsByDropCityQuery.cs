...
{
    public class GetCargoAdsByDropCityQuery : IRequest<IEnumerable<CargoAdDto>>
    {
        public string City { get; set; }
        public byte? Status { get; set; }
    }

    public class GetCargoAdsByDropCityQueryHandler : IRequestHandler<GetCargoAdsByDropCityQuery, IEnumerable<CargoAdDto>>
    {
        ...
        public async Task<IEnumerable<CargoAdDto>> Handle(GetCargoAdsByDropCityQuery request, CancellationToken cancellationToken)
        {
