...
{
    public class GetAllCargoAdsQuery : IRequest<IEnumerable<CargoAdDto>>
    {
        public byte? Status { get; set; }
    }

    public class GetAllCargoAdsQueryHandler : IRequestHandler<GetAllCargoAdsQuery, IEnumerable<CargoAdDto>>
    {
        ...
        public async Task<IEnumerable<CargoAdDto>> Handle(GetAllCargoAdsQuery request, CancellationToken cancellationToken)
        {
